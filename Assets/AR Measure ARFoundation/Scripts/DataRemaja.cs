public class DataRemaja
{
    ...
    public DataRemaja(string _nama, string _umur, int _beratBadan, int _tinggiBadan, float _imt, string _kIMT, string _lingkarLengan, string _hb, string _kAnemia, string _hasilRekomendasi)
    {
        this.nama = _nama;
        this.umur = _umur;
